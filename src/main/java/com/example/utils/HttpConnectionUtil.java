...
public class HttpConnectionUtil {
    ...
    public static String downloadFile(String urlPath, String downloadDir) {
        ...
        try {
            ...
            httpURLConnection.setRequestProperty("User-Agent", "Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.84 Safari/537.36");
            ...
            //文件请求 真实URL地址
            URL map3Url = httpURLConnection.getURL();

            //System.out.println(map3Url+"");

            // 文件名
            String filePathUrl = map3Url.getFile();
